...
v4.2.0 통합 배포물에는 Electron의 `LICENSE`, `LICENSES.chromium.html`,
`licenses/npm/`의 포함 패키지 고지, `licenses/npm-components.json` 목록을 동봉합니다.
기록 엔진과 교체 가능한 네이티브 DLL은 `resources/engine/`에 있습니다.
