...
module.exports=function nativeBridge(onState){
 const child=spawn(path.join(__dirname,'../artifacts/bridge/공공AX-업무매크로.exe'),['--bridge','--parent-pid',String(process.pid)],{windowsHide:true,stdio:['pipe','pipe','pipe']});
